...
import com.razzolim.food.api.v1.openapi.model.RestauranteBasicoModelOpenApi;
...
public interface RestauranteControllerOpenApi {
    ...
    @ApiResponses({
        @ApiResponse(code = 400, message = "ID do restaurante inv�lido", response = Problem.class),
    ...
    RestauranteModel adicionar(
            @ApiParam(name = "corpo", value = "Representa��o de um novo restaurante", required = true)
    ...
    RestauranteModel atualizar(
            ...
            @ApiParam(name = "corpo", value = "Representa��o de um restaurante com os novos dados", 
                required = true)
            RestauranteInput restauranteInput);
    ...
    @ApiOperation("Ativa m�ltiplos restaurantes")
    @ApiResponses({
    ...
    @ApiOperation("Inativa m�ltiplos restaurantes")
    @ApiResponses({
        @ApiResponse(code = 204, message = "Restaurantes ativados com sucesso")
    })
