...
public interface FormaPagamentoControllerOpenApi {
    ...
    @ApiResponses({
        @ApiResponse(code = 400, message = "ID da forma de pagamento inv√°lido", response = Problem.class),
        @ApiResponse(code = 404, message = "Forma de pagamento n√£o encontrada", response = Problem.class)
    })
    ...
    public FormaPagamentoModel adicionar(
    		@ApiParam(name = "corpo", value = "RepresentaÁ„o de uma nova forma de pagamento", 
    			required = true)
    ...
    public FormaPagamentoModel atualizar(
    		...
    		@ApiParam(name = "corpo", value = "RepresentaÁ„o de uma forma de pagamento com os novos dados", 
    			required = true)
    		FormaPagamentoInput formaPagamentoInput);
    
    @ApiOperation("Exclui uma forma de pagamento por ID")
    @ApiResponses({
        @ApiResponse(code = 204, message = "Forma de pagamento exclu√≠da"),
        @ApiResponse(code = 404, message = "Forma de pagamento n√£o encontrada", response = Problem.class)
    })
    public void remover(
    		@ApiParam(value = "ID de uma forma de pagamento", example = "1", required = true)
