...
import com.razzolim.food.api.openapi.controller.RestauranteControllerOpenApi;
...
public class RestauranteController implements RestauranteControllerOpenApi {
	 ...
	 * restauranteRepository.findAll(); List<RestauranteModel> restaurantesModel =
...
//		"dataCadastro", "produtos");
	 ...
	 * field.setAccessible(true); Object novoValor = ReflectionUtils.getField(field,
	 * restauranteOrigem); ReflectionUtils.setField(field, restauranteDestino,
	 * novoValor); }); } catch (IllegalArgumentException error) { Throwable
	 * rootCause = ExceptionUtils.getRootCause(error); throw new
	 * HttpMessageNotReadableException(error.getMessage(), rootCause,
	 * serverHttpRequest); } }
	 */
}
